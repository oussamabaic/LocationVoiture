    ...
    <div class="container register-form">
        <div class="form">
            ...
            <div class="form-content">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Nom du Voiture" name="nom_voiture"
                                value="" />
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Vitesse" name="vitesse" value="" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Modeles" name="model" value="" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Reserver" name="reserver" value="" />
                        </div>
                ...
                <input type="submit" name="AjouterVoiture" class="btn btn-success" value="Ajouter Voiture">
                </form>
            </div>
        </div>
    </div>
